-- 3НФ: Role, Category, Manufacturer, Supplier, PickupPoint, OrderStatus — справочники.
CREATE DATABASE IF NOT EXISTS pets CHARACTER SET utf8mb4;
USE pets;

CREATE TABLE IF NOT EXISTS Role (ID INT AUTO_INCREMENT PRIMARY KEY, Name VARCHAR(40) UNIQUE NOT NULL);
...
CREATE TABLE IF NOT EXISTS Category    (ID INT AUTO_INCREMENT PRIMARY KEY, Name VARCHAR(80) UNIQUE NOT NULL);
CREATE TABLE IF NOT EXISTS Manufacturer(ID INT AUTO_INCREMENT PRIMARY KEY, Name VARCHAR(80) UNIQUE NOT NULL);
CREATE TABLE IF NOT EXISTS Supplier    (ID INT AUTO_INCREMENT PRIMARY KEY, Name VARCHAR(80) UNIQUE NOT NULL);
CREATE TABLE IF NOT EXISTS PickupPoint (ID INT AUTO_INCREMENT PRIMARY KEY, Address VARCHAR(255) UNIQUE NOT NULL);
